  ...
  <div class="pageMain">
      ...
      <el-row style="padding:30px 0px">
        <el-col :span="12" style="margin-top:10px;float:left;text-align: left;">
             <template slot-scope="">
                <router-link to='/commonReport'>
                    <el-button type="primary" plain  @click.native="add" > 新建普通报表</el-button>
                </router-link>
             </template>
         </el-col>
    ...
    <div>
        ...
        <el-table  :data="tableData" style="width:100%;" :header-cell-style="{background:'rgb(232, 241, 251)',color:'#606266'}">
            ...
            <el-table-column prop="zt" label="状态" style="width:15%;"></el-table-column>
            <el-table-column prop="zhczsj" label="最后操作时间" style="width:15%;"></el-table-column>
            <el-table-column prop="cz" label="操作" style="width:10%;">
            <template slot-scope="scope">
                <router-link to='/commonReport'>
                    <el-button  @click="edit" type="primary" plain size="small">编辑 </el-button>
                </router-link>
                <el-button @click.native.prevent="deleteRow(scope.$index, tableData)" type="primary" plain size="small" style="margin-left:20px;">删除</el-button>
            </template>
            </el-table-column>
